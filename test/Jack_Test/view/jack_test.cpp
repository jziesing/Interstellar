...
int main(int argc, char const *argv[])
{
	...
	title banner(CENTER[0], CENTER[1]-60, "Mustache vs Tripod Simulation", 80, 1);
	...
	while (window.isOpen())
	{
		...
		//simulation
			...
			if (numberOfUfos > 1) {
				...
				cilk_for (int n=0; n< numberOfUfos; n++) {
					ufoAlive[n] = true;
					laserAlive[n] = true;
				}
				...
				cilk_for (int i=0; i<numberOfUfos; i++) {
					//collision with ufos
					cilk::reducer_opand<bool> ufo_reducer(true);
					ufo_reducer.set_value(true);
